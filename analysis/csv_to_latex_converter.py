...
if __name__ == "__main__":
    csv_file = "results/summary/humaneval_pass_rates_only.csv"
    latex_table = convert_csv_to_latex(csv_file)
    print(latex_table)
    # Also save to file
    with open("results/summary/humaneval_latex_table.tex", "w") as f:
        f.write(latex_table)
    
    csv_file = "results/summary/mbpp_pass_rates_only.csv"
    latex_table = convert_csv_to_latex(csv_file)
    print(latex_table)
    
    with open("results/summary/mbpp_latex_table.tex", "w") as f:
        f.write(latex_table)
