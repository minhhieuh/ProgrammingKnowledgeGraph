...
def load_model_pricing(csv_filename: str = "data/benchmarks/model_pricing.csv") -> Dict[str, Dict[str, float]]:
...
def load_augmented_data(augmentation_type: str, benchmark: str) -> Dict[str, Any]:
    ...
    file_mapping = {
        'voyage_func': f'data/augmented_problems/{benchmark}_function_wise_relevant_context.jsonl',
        'voyage_block': f'data/augmented_problems/{benchmark}_blockwise_relevant_context.jsonl',
        'bm25': f'data/augmented_problems/bm25_relevant_context_{benchmark}.jsonl',
        'voyage_emb': f'data/augmented_problems/voyage_code_relevant_context_{benchmark}.jsonl'
    }
