...
if __name__=="__main__":
    ...
    if augmentation_type == "voyage_func":
        context_data_path = "data/augmented_problems/humaneval_function_wise_relevant_context.jsonl"
        ...
        context_data_path = "data/augmented_problems/humaneval_block_wise_relevant_context.jsonl"
        augmented_data = make_augmented_data(context_data_path)
        generate_code(dest_path,problems,model,tokenizer, model_type,augmented_data)

    elif augmentation_type == "bm25":
        context_data_path = "data/augmented_problems/bm25_relevant_context_humaneval.jsonl"
