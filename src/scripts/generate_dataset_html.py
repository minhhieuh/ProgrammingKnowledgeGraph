...
def load_augmented_data() -> Dict[str, Dict[str, Any]]:
    ...
    file_mappings = {
        # HumanEval files
        'function_wise': [
            'data/augmented_problems/humaneval_function_wise_relevant_context.jsonl',
            'data/augmented_problems/mbpp_function_wise_relevant_context.jsonl'
        ],
        'block_wise': [
            'data/augmented_problems/humaneval_blockwise_relevant_context.jsonl',
            'data/augmented_problems/mbpp_blockwise_relevant_context.jsonl'
        ],
        'bm25': [
            'data/augmented_problems/bm25_relevant_context_humaneval.jsonl',
            'data/augmented_problems/bm25_relevant_context_mbpp.jsonl'
        ]
    }
